...
const WorkTestimonialContainer = () =>
<div id="workTestimonialContainer">
  <div className="workTestimonialContent">
    <div className="container">
    <div className="row testimonialIntro">
    <div className="col-md-offset-3 col-md-2 ">
    <h2 className="workTestimonialLede">Work Testimonials</h2>
    </div>
    <div className="col-md-6">
      <p className="testimonialBlurb">Here’s what our customers have to say.</p>
    </div>
  </div>
  <div className="row testimonialBlock">
...
how big or small the task is. I will use their services for the rest of my life&quot;</p><br/><div className="attribution text-right">- John Stevens Sr.</div>
  ...
  <div className="row testimonialBlock">
    <div className="col-md-5  col-md-offset-6 testimonialOffset">
...
working with you again and again.&quot;</p> <br/><div className="attribution text-right">- Joseph Szabo - Direct Buy Service Manager</div>
  ...
  <div className="row testimonialBlock">
    <div className="col-md-5 testimonialOffset">
...
export default WorkTestimonialContainer
